...
# print(get_evaluatable().create_from(test).evaluate())
for i in get_evaluatable().create_from(test).evaluate():
    print(i)
q =[i for i in get_evaluatable().create_from(test).evaluate()]
print(len(q))
